...
impl ShadowRenderer {
    ...
    fn supports_storage_resources(adapter: &wgpu::Adapter, device: &wgpu::Device) -> bool {
        adapter
    ...
    fn light_uniform_size() -> wgpu::BufferAddress {
                    ...
                    device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                        entries: &[
                            ...
                            wgpu::BindGroupLayoutEntry {
                                ...
                                ty: wgpu::BindingType::Buffer {
                                    ty: if Self::supports_storage_resources(&adapter, &device) {
...
impl RenderPass for ShadowRenderer {
    fn render(
        ...
        encoder.push_debug_group("forward rendering pass");
        {
            ...
            pass.set_pipeline(&forward_pass.pipeline);
            pass.set_bind_group(0, &forward_pass.bind_group, &[]);
