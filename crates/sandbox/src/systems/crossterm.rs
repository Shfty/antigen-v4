...
#[profiling::function]
pub fn crossterm_input_buffer_fill(receiver: &crossbeam_channel::Receiver<crossterm::event::Event>, events: &mut CrosstermEventQueue) {
...
#[profiling::function]
pub fn crossterm_quit_on_ctrl_c(
    events: &CrosstermEventQueue,
    main_loop_state: &mut MainLoopState,
) {
    for event in events.iter() {
        ...
        {
            *main_loop_state = MainLoopState::Break;
        }
    }
}
